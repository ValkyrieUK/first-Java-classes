public abstract class Account implements Detailable {
	...
	// constructors
	public Account(String s, double d) throws DodgyNameException {
		if (s.equals("Fingers")){
	...
	public void setAccountName(String s) throws DodgyNameException {
		if (s.equals("Fingers")){
			throw new DodgyNameException();
		}
		accountName = s;
	...
	public boolean withdraw() {
		...
		if ((balance - 20) > 0) {
			...
			System.out.println("There is now �" + balance
					+ " left in your account.");
		} else
			System.out.println("Sorry not enough money. YOu only have �"
					+ balance);
		return flag;
	}
